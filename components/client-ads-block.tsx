...
export function ClientAdsBlock(props: { nativeScripts: any[] }) {
  return (
    <>
      {/* Top Banner Strip */}
      <AdBanner slot={1} />
      {/* Top Banner Adsterra (slot 1) */}
      <div className="mb-4 flex justify-center">
        <AdBanner slot={1} scripts={[{
          iframe: true,
          src: 'https://corruptioneasiestsubmarine.com/ea31a2b23b71044ce04e59b9147c7ffc/invoke.js',
          width: 728,
          height: 90
        }]} />
      </div>
      ...
      <div className="mt-5 mb-6 flex items-center justify-center">
        <div className="max-w-[468px]">
          <AdBanner slot={2} scripts={[{
            iframe: true,
            src: 'https://corruptioneasiestsubmarine.com/1ef074fb53b9c298ba4b329b92f27240/invoke.js',
            width: 468,
            height: 60
          }]} />
        </div>
      </div>
      {/* Middle Banner Strip (728x90) - top of features */}
      <div className="my-6 flex items-center justify-center">
        <AdBanner slot={1} />
      </div>
      {/* Native Ad Block Adsterra (slot_native) */}
      <div className="mt-6">
